...
function obtener_post($post_por_pagina, $conexion){
    $incio = (pagina_actual() > 1) ? pagina_actual() * $post_por_pagina - $post_por_pagina: 0;
    $sentencia = $conexion-> prepare("SELECT SQL_CALC_FOUND_ROWS * FROM articulos limit $incio, $post_por_pagina");
    $sentencia->execute();
